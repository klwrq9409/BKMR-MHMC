...
import joblib
import sys
from momentum.hmc.mixed_hmc_jax4 import mixed_hmc_on_joint
...
filenames='/Simulation/Correlated/N500/m200/data_n500_m200_6ind_highcorr_{}.json'.format(id)
...
delta=np.zeros(M)
group=np.append(np.array([1,2,1]), np.arange(3,M))
...
results_fname = '/Simulation/Correlated/N500/m200/results/bkmr-mhmc/results.joblib_highcorr_m200_{}'.format(id)
