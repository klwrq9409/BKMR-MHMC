library(bkmr)
files=list.files(pattern = "*knots","/Simulation/Correlated/N500/m50/results/bkmr/")
...
for (i in index) {
  fit<-readRDS(paste0("/Simulation/Correlated/N500/m50/results/bkmr/fitkm_bkmr_knots_",i,".rds"))
