library(bkmr)
files=list.files(pattern = "*knots","/Simulation/6ind/N500/m200/results/bkmr/")
...
for (i in index) {
  fit<-readRDS(paste0("/Simulation/6ind/N500/m200/results/bkmr/fitkm_bkmr_knots_",i,".rds"))
